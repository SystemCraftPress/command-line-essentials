...
| ---------- | ------------ | ----- |
| PDF + EPUB | [Payhip](https://payhip.com/b/xRFni) | $9.99 |

Use code **GITHUB10** at checkout for 10% off. Learn more at [systemcraftpress.com](https://systemcraftpress.com/guides/command-line-essentials/).
